...
var Import = function Import(props) {
	return React.createElement(
		...
		React.createElement(
			_toolbox.GridCell,
			null,
			React.createElement(Input, { onChange: props.onChangeXml }),
			React.createElement(
				"div",
				null,
				React.createElement(
...
exports.default = function () {
	return React.createElement(_reactRouterDom.Route, { path: "/import/:spaceId/:accessToken", component: EnhancedImport });
};