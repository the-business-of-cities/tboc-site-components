...
}, mixins.shadow(2), vars.dim.nav.height.xs, function (props) {
...
var buttonStyle = [(0, _styledComponents.css)(["display:block;padding:0.9em ", ";font-size:0.9em;content:", ";line-height:1;&.active{font-weight:bold;background-color:", ";}"], vars.dim.nav.margin.xs, _ramda2.default.pipe(_ramda2.default.path(["theme", "nav"])), _ramda2.default.pipe(_ramda2.default.path(["theme", "nav"]), function (color) {
...
})(["position:relative;", ";", ";"], mixins.xs(_templateObject2, _ramda2.default.pipe(_ramda2.default.path(["theme", "nav"]), function (color) {
...
var Link = (0, _styledComponents2.default)(_reactRouterDom.NavLink).withConfig({
	...
	return props.theme.colors.logo1;
}, mixins.xs(_templateObject, buttonStyle[0]), mixins.bp.sm.min(_templateObject, buttonStyle[1]));

var DropdownLinks = _styledComponents2.default.div.withConfig({
	displayName: "Links__DropdownLinks"
})(["", " ", ";"], mixins.xs(_templateObject4), mixins.bp.sm.min(_templateObject5, _ramda2.default.pipe(_ramda2.default.path(["theme", "nav"]), mixins.lightenColor), vars.dim.nav.linksHeight));
...
exports.default = function (_ref) {
	var links = _ref.links,
	    close = _ref.close,
	    open = _ref.open,
	    props = (0, _objectWithoutProperties3.default)(_ref, ["links", "close", "open"]);
		...
		links && links.map(function (link) {
			return _react2.default.createElement(
				...
				link.dropdown && _react2.default.createElement(
					DropdownLinks,
					null,
					link.dropdown.links.map(function (_ref2) {
