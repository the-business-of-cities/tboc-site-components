...
})(["background-color:", ";color:white;position:fixed;bottom:0;left:0;right:0;padding:", ";display:flex;flex-direction:row;align-items:center;justify-content:center;z-index:1;line-height:1;transform:translateY(", ");transition:0.2s ease-in transform;font-size:0.8em;", " ", ";"], _ramda2.default.path(["theme", "nav"]), gutter, function (props) {
...
var Comp = function Comp(_ref6) {
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			CloseButton,
			{ onClick: hide },
			_react2.default.createElement(_toolbox.Icon, { type: "times" })
		)
	);
};
