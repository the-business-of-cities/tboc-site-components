...
var textBoxMargins = mixins.objectMap(vars.font.size, function (key, val) {
	return "-" + val + " auto";
});
...
var Icon = exports.Icon = function Icon(props) {
	return _react2.default.createElement(IconWrapper, (0, _extends3.default)({ className: "fa fa-" + props.type }, props));
};
...
var IconButton = exports.IconButton = function IconButton(props) {
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			ButtonWrapper,
			props,
			props.icon ? _react2.default.createElement(Icon, { type: props.icon, size: "1.2em", marginRight: "0.4em" }) : null,
			_react2.default.createElement(
				IconSpan,
				null,
...
var Only = exports.Only = mixins.objectMap(vars.bps, function (key, val) {
	return function (_ref2) {
		var children = _ref2.children;
		return _react2.default.createElement(_reactResponsive2.default, {
