...
const textMargins = mixins.objectMap(theme.font.size, (key, val) => val + " 0");
	...
	*, *:before, *:after {
	...
	h3 {
		...
		:after {
			...
			display: block;
			width: 5em;
			border-bottom: 0.4em solid ${ theme.colors.bgdark };
		}
	}

	hr {
		border: 0;
		border-top: 0.4em solid ${ theme.colors.bgdark };
		margin: 2em 0;
	}
`;
